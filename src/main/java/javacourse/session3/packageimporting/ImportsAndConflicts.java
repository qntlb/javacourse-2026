package javacourse.session3.packageimporting;
...
import javacourse.session3.useful.*;
...
//		Vector v1 = new Vector(); 
		...
		javacourse.session3.useful.Vector thirdVector = new javacourse.session3.useful.Vector(); 
	}
