...
public class Amphibian{
	 ...
	 * inside. We don't have to bother writing if amphibian is of type Frog or if it is of type Toad: at 
	 * running time, Java is able to get the type of the object, so that the right implementation of
