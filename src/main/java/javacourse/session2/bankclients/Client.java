 ...
 * there's a quite high probability to do mistakes: for example, one might invert
 * the order in which two strings are called in the constructor. To avoid this, you might want to
